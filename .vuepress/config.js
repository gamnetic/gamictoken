...
module.exports = {
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://gamnetic.github.io/gamic' }],
    ['meta', { property: 'og:image', content: 'https://gamnetic.github.io/gamic/assets/images/watch-token.png' }], // eslint-disable-line max-len
    ['meta', { property: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { property: 'twitter:image', content: 'https://gamnetic.github.io/gamic/assets/images/watch-token.png' }], // eslint-disable-line max-len
